...
public class CustomResourceExistsException extends RuntimeException {
    @Serial
    private static final long serialVersionUID = 1L;

    private static final Logger log = LoggerFactory.getLogger(CustomResourceExistsException.class);
    ...
    public CustomResourceExistsException(String resource, String field, String prop, Long value) {
